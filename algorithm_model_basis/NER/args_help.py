...
parser.add_argument('--savemode_dir',type=str,default='savemode_mix/',help='svaemode_dir')
...
parser.add_argument("--mix_word_char", type=bool, default=True,help='use char or use char and word')
parser.add_argument("--word_per_path", type = str, default='./pyhanlp/fasttext_100.model', help='pre train vector')
